...
// 이건 정리 필요
export function setHelper (scene, camera, cameraRotateGroupX, cameraRotateGroupY, cameraTarget, cameraOffset, options) {
  const defaults = {
  ...
  // gui - env
  const folderEnv = gui.addFolder('Enviroment');
